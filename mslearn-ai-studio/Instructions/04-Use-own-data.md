...
1. Select **Create vector index** and **wait** for the indexing process to be **completed**, which can take a while depending on available compute resources in your subscription.
